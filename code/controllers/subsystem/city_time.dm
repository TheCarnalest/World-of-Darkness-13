				...
				if(H.stat != DEAD)
					if(H.key)
						...
						if(P)
							P.add_experience(1)
							if(H.mind)
								if("[H.mind.assigned_role]" == "Prince")
									P.add_experience(25)
								if("[H.mind.assigned_role]" == "Baron")
									P.add_experience(25)
								if("[H.mind.assigned_role]" == "Dealer")
									P.add_experience(20)
								if("[H.mind.assigned_role]" == "Sheriff")
									P.add_experience(20)
								if("[H.mind.assigned_role]" == "Chantry Regent")
									P.add_experience(20)
								if("[H.mind.assigned_role]" == "Seneschal")
									P.add_experience(15)
								if("[H.mind.assigned_role]" == "Graveyard Keeper")
									P.add_experience(15)
								...
								if("[H.mind.assigned_role]" == "Archivist")
									P.add_experience(15)
								if("[H.mind.assigned_role]" == "Supply Technician")
									P.add_experience(15)
								if("[H.mind.assigned_role]" == "Scourge")
									P.add_experience(10)
								if("[H.mind.assigned_role]" == "Bouncer")
									P.add_experience(10)
								if("[H.mind.assigned_role]" == "Stripper")
									P.add_experience(10)
							if(!HAS_TRAIT(H, TRAIT_NON_INT))
								if(won)
									if(H.vampire_faction == won)
