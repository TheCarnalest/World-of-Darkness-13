...
/mob/proc/ghostize(can_reenter_corpse = TRUE, aghosted = 0)
	...
	*/
		...
		ghost.sight = SEE_TURFS | SEE_MOBS | SEE_OBJS// [Lucifernix] - This is where ChillRaccoon fucked up ghost sight. Reuse for wraith if you want.
		ghost.movement_type = PHASING // [ChillRaccoon] - makes us available to go through dens objects //[Lucifernix] - It was ghost.movement.type += PHASING, which is what made aghosts unable to walk through walls for some reason.
