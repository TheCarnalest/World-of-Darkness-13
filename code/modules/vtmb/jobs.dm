...
/datum/job/vamp/giovanni
	...
	total_positions = 4
	spawn_positions = 4
	supervisors = "the Family and the Capo"
	selection_color = "#cb4aad"
	...
	v_duty = "Whether brought into the fold by your own choice or having your arm twisted. You now find yourself as an associate of the family, helping further expand their reach within the city."
	minimal_masquerade = 0
	experience_addition = 10
	allowed_species = list("Vampire")
	allowed_bloodlines = list("Daughters of Cacophony", "Brujah", "Tremere", "Ventrue", "Nosferatu", "Gangrel", "Toreador", "Malkavian", "Banu Haqim", "Ministry", "Gargoyle")
