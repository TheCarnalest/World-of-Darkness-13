...
/datum/outfit/job/police_officer
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/implant/radio=1, /obj/item/vamp/creditcard=1, /obj/item/gun/ballistic/vampire/revolver/snub=1, /obj/item/ammo_box/vampire/c9mm/moonclip = 4)
