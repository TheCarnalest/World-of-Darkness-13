...
/atom/movable/screen/blood/Click()
	if(iscarbon(usr))
		...
		if(BD.bloodpool > 0)
			to_chat(BD, "<span class='notice'>You've got [trunc(BD.bloodpool)]/[BD.maxbloodpool] blood points.</span>")
		else
			to_chat(BD, "<span class='warning'>You've got [trunc(BD.bloodpool)]/[BD.maxbloodpool] blood points.</span>")
	..()
